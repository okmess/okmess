 ...
 *
 */
public class UseLoginDAOImpl implements IUseLoginDAO{
	 ...
	 * @param conn 连接
	 */
	public UseLoginDAOImpl(Connection conn) {
		this.conn=conn;
	}
	@Override
	public boolean doCreate(Login vo) {
		String sql="insert into UseLogin(useName,password)values(?,?)";
		boolean i=false;
		try {
	...
	public boolean doUpdate(Login vo) {
		String sql="update UseLogin set password=? where useName=?";
		boolean i=false;
		try {
			this.pstmt=this.conn.prepareStatement(sql);
	...
	public boolean doRemove(String userName) {
		String sql="delete from UseLogin where useName=?";
		boolean i=false;
		try {
			this.pstmt=this.conn.prepareStatement(sql);
	...
	public Login findByUserName(String userName) {
		String sql="select useName,password from UseLogin where useName=?";
		ResultSet rs = null;
		Login vo=null;
		try {
			this.pstmt=this.conn.prepareStatement(sql);
	...
	public Vector<String> findAllUserName(){
		String sql="select useName from UseLogin";
		ResultSet rs = null;
